...
public class Admin extends Color{
    private static int id;
    private static String userType;
    static String [] menu = {"Player(--player)", "Coach(--coach)", "Match(--match)", "Playing-Team(--pteam)", "Profile(--profile)", "Logout(--logout)"};
    ...
    public static void main(String[] args) {
        ...
        if (list.equals("--list")){
            ...
            if (text.equals("--coach")){
                Coach c = new Coach(id, userType);
            }else if (text.equals("--pteam")){
