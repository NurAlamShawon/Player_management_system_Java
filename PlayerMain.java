...
public class PlayerMain extends Color{
    private static int id;
    private static String userType;
    static String [] menu = {"Match(--match)", "Playing-Team(--pteam)", "Profile(--profile)", "Logout(--logout)"};

    public PlayerMain (int id, String userType) {
        this.id = id;
